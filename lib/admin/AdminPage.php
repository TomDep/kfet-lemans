...
?>
    <main class="container bg-light mb-5 pb-3 rounded">
        ...
        <h1 class="text-center"><?php echo $this->page_title ?></h1>

        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link active" id="table-tab" data-toggle="tab" href="#table-div" role="tab">Table</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="new-user-tab" data-toggle="tab" href="#new-user-div" role="tab">Ajout</a>
            </li>
        </ul>

        <div class="tab-content border-bottom border-left border-right p-3 bg-white">
            <div class="tab-pane fade show active" id="table-div" role="tabpanel">
                <div>
                    <h2 class="mb-4">Données enregistrées</h2>
